    ...
    return (
        <div className="bg-white shadow-md overflow-hidden relative">
            ...
            <div className="px-4 flex flex-col justify-between py-10">
                <h2 className="text-lg text-blue-50 font-semibold mt-2 md:w-[70%] sm:w-full">{title}</h2>
                <p className="text-blue-50 font-normal mt-2 text-base md:w-[75%] w-full">{description}</p>
            </div>
